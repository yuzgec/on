...
@section('title', $Edit->title.' | Ürün ÖZellik Düzenle')
@section('content')
    {{Form::model($Edit, ["route" => ["attribute.update", $Edit->id],'enctype' => 'multipart/form-data'])}}
    @method('PUT')
    <div class="row">
        <div class="col-12 col-md-9">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <x-form-inputtext label="Özellik Adı" name="name"></x-form-inputtext>
                </div>
            </div>
