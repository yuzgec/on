<section id="home" class="relative white height-100vh height-60vh-sm mnh-450 align-items-center d-flex">
    ...
    <!-- End keeper for SVG backdrop -->

     <!-- Video - Parent * should have "relative" class -->
     <div class="videobg bg-soft bg-soft-dark2" data-background="content/seta/images/video-01-poster.jpg">
          <video poster="content/seta/images/video-01-poster.jpg" playsinline autoplay muted loop>
