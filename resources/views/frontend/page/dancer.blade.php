    ...
    <div class="container-md">
       <div class="t-center mt-25">
          ...
          <div class="mt-30 uppercase fs-12 bold bg-soft-dark3 radius-lg py-10 px-40 d-inline-flex width-auto lh-normal align-items-center">
             ...
             <a href="{{ route('team')}}" class="stay c-default opacity-7">Eğitmenler</a><i class="ti-angle-right fs-7 mx-15"></i> 
        ...
        <div class="row">
            <div class="col-md-8 col-12 pt-50">
                <span class="fs-20 fs-16-sm gray7 ls-0 lh-35 light">
                    ...
                    <h6 class="colored fs-11 ls-6 uppercase "> {{ $Detay->seo_key}}</h6>
                    <h2 class="lh-40 font-sedgwick mt-10 ">
                        {{ $Detay->title}}
                    </h2>
            ...
            <div class="col-md-4 col-12 bg-gray">   
                <div class="fs-15 gray8  lh-lg mb-30  px-15-sm py-50 py-20-sm">
                   <img src="{{ $Detay->getFirstMediaUrl('page') }}" alt="{{ $Detay->title}}" class="img-fluid">
                </div>
            </div>  
